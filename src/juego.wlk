...
//const piso nivel0 = new Ladrillo()
		...
		puertaMagica.crearZanahorias([ game.at(19,9), game.at(13,5), game.at(3,9), game.at(10,11), game.at(5,13) ])
		...
		(0 .. largo).forEach{ n => posicionNiveles.add(game.at(0, n))}
		(0 .. largo).forEach{ n => posicionNiveles.add(game.at(ancho, n))}
		posicionNiveles.addAll([ game.at(5,4), game.at(6,4), game.at(7,4), game.at(8,4), game.at (9,4), game.at (10,4), game.at (11,4), game.at (12,4), game.at (13,4), game.at (14,4), game.at (15,4), game.at (16,4), game.at (17,4), game.at (18,4) ])
		posicionNiveles.addAll([ game.at(1, 8), game.at(2, 8), game.at(3,8), game.at(4,8), game.at(5,8), game.at(6,8), game.at(18,8), game.at(19,8), game.at(20,8), game.at(21,8), game.at(22,8), game.at(23,8), game.at(24,8) ])
		posicionNiveles.addAll([ game.at(1, 12), game.at(2,12), game.at(3,12), game.at(4,12), game.at(5,12), game.at(6,12), game.at (18,12), game.at (19,12), game.at (20,12), game.at (21,12), game.at (22,12), game.at (23,12), game.at (24,12) ])
		posicionNiveles.addAll([ game.at(9, 10), game.at(10,10), game.at(11,10), game.at(12,10), game.at(13,10), game.at(14,10), game.at(15,10) ])
...
//LOGICA PARA PUERTAS
		...
		puerta4.creoPuertaEn(game.at(22, 9))
			// puerta del final
		puertaMagica.crearZanahorias([ game.at(4,5), game.at(4,9), game.at(3,13), game.at(23,13), game.at(18,5) ])
...
//LADRILLOS
	self.bordesDelMapa(ancho,largo)
		...
		(0 .. largo).forEach{ n => posicionNiveles.add(game.at(0, n))}
		(0 .. largo).forEach{ n => posicionNiveles.add(game.at(ancho, n))}
		paredMedio.addAll([ game.at(12,1), game.at(12,2), game.at(12,3), game.at(12,4), game.at(12,5), game.at(12,6), game.at(12,7), game.at(12,8), game.at(1,4), game.at(2,4), game.at(3,4), game.at(4,4), game.at(5,4), game.at(6,4), game.at(7,4), game.at(8,4), game.at(9,4), game.at(10,4), game.at(11,4), game.at(13,4), game.at(14,4), game.at(15,4), game.at(16,4), game.at(17,4), game.at(18,4), game.at(19,4), game.at(20,4) ])
		posicionNiveles.addAll([ game.at(1, 8), game.at(2, 8), game.at(3, 8), game.at(4, 8), game.at(5,8), game.at(6,8), new Position(7,8), new Position(8,8), new Position(9,8), new Position(10,8), new Position(11,8), new Position(15,8), new Position(16,8), new Position(17,8), new Position(18,8), new Position(19,8), new Position (20,8), new Position (21,8), new Position (22,8), new Position (23,8), new Position (24,8) ])
